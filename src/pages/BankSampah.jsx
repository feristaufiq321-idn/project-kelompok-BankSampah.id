...
export const SiteFooterLinksSection = () => {
  return (
...
export const WasteBankLocatorSection = () => {
...
const TemukanBankSampah = () => {
  return (
    <main className="bg-[linear-gradient(0deg,rgba(252,248,255,1)_0%,rgba(252,248,255,1)_100%),linear-gradient(0deg,rgba(255,255,255,1)_0%,rgba(255,255,255,1)_100%)] w-full min-h-screen relative">
      <PrimaryNavigationSection />
      <WasteBankLocatorSection />
      <SiteFooterLinksSection />
    </main>
  );
};

export default TemukanBankSampah;
